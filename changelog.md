...
* 1.1.4.0-release - `<Archival>` edition
* 1.1.3.0-release - `<Archival>` edition
* 1.1.2.0-release - `<Archival>` edition
...
* Issues
  * closes #1 - Ariane 6 (ARIANE) 1.1.99.0-adoption `<Thank you Matheo G>` edition
